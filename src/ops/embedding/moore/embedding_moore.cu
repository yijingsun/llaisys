#include "embedding_moore.cuh"
#include <musa_runtime.h>
#include "../../../utils.hpp"
#include <cstdio>
#include <cstdlib>

#define CHECK_MUSA(call) do { musaError_t error = (call); if (error != musaSuccess) { std::fprintf(stderr, "MUSA error: %s\n", musaGetErrorString(error)); std::abort(); } } while (0)
